				...
				div.innerHTML = `
					...
					<div class="_3j7s9">
							<div class="_2FBdJ">
									...
									<div class="_3Bxar">
											<span class="_3T2VG">${Format.timeStampToTime(contact.lastMessegeTime)}</span>
									</div>
							</div>
							<div class="_1AwDx">
									<div class="_itDl">
											...
											<span class="_2_LEW last-message">
													...
													<span dir="ltr" class="_1wjpf _3NFp9">${contact.lastMessege}</span>
													<div class="_3Bxar">
															<span>
																	<div class="_15G96">
	...
	initEvents() {
		...
		this.el.inputProfilePhoto.on('change', e=> {
			...
			if (this.el.inputProfilePhoto.files.length > 0) {
				...
				Upload.send(file, this._user.email).then(downloadURL => {
					...
					let uploadFile = downloadURL
					this._user.photo = uploadFile;
					this._user.save().then(() => {
		...
		this.el.inputNamePanelEditProfile.on('keypress', e => {
			...
			this.el.btnSendPicture.on('click', e=> {
				console.log('TCL: Image', this.el.pictureCamera.src);
